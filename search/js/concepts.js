...
const CONCEPT_EXPANSIONS = {
  ...
  // ── Emotional states & mental health ─────────────────────────────────────
  'overwhelmed':    ['ص ب ر', 'ب ل و', 'ت و ك ل'],
  'stressed':       ['ص ب ر', 'ت و ك ل', 'ذ ك ر'],
  'anxious':        ['خ و ف', 'ت و ك ل', 'ذ ك ر'],
  'anxiety':        ['خ و ف', 'ت و ك ل', 'ص ب ر'],
  'worried':        ['خ و ف', 'ت و ك ل'],
  'worry':          ['خ و ف', 'ت و ك ل'],
  'hopeless':       ['ر ج و', 'ر ح م', 'ق ن ط'],
  'hopelessness':   ['ر ج و', 'ق ن ط'],
  'despair':        ['ر ج و', 'ر ح م', 'ق ن ط'],
  'despairing':     ['ر ج و', 'ق ن ط'],
  'lonely':         ['ر ح م', 'ا ن س', 'ت و ك ل'],
  'loneliness':     ['ر ح م', 'ا ن س'],
  'sad':            ['ح ز ن', 'ص ب ر'],
  'sadness':        ['ح ز ن', 'ص ب ر'],
  'grief':          ['ح ز ن', 'ص ب ر', 'ر ح م'],
  'grieving':       ['ح ز ن', 'ص ب ر'],
  'heartbroken':    ['ح ز ن', 'ص ب ر', 'ق ل ب'],
  'depressed':      ['ح ز ن', 'ص ب ر', 'ر ح م'],
  'depression':     ['ح ز ن', 'ص ب ر', 'ر ح م'],
  'angry':          ['ح ل م', 'ص ب ر', 'غ ض ب'],
  'anger':          ['غ ض ب', 'ح ل م', 'ص ب ر'],
  'rage':           ['غ ض ب', 'ح ل م'],
  'guilty':         ['ت و ب', 'غ ف ر', 'ذ ن ب'],
  'guilt':          ['ت و ب', 'غ ف ر', 'ذ ن ب'],
  'ashamed':        ['ت و ب', 'غ ف ر'],
  'shame':          ['ت و ب', 'غ ف ر'],
  'regret':         ['ت و ب', 'ن د م'],
  'doubt':          ['ي ق ن', 'ا م ن'],
  'doubtful':       ['ي ق ن', 'ا م ن'],
  'confused':       ['ه د ي', 'ن و ر'],
  'lost':           ['ه د ي', 'ض ل ل'],
  'purpose':        ['خ ل ق', 'ع ب د', 'ه د ي'],
  'meaning':        ['خ ل ق', 'ع ب د'],
  'empty':          ['ذ ك ر', 'ر ح م', 'ق ل ب'],
  'ungrateful':     ['ش ك ر', 'ن ع م'],
  'ungratefulness': ['ش ك ر', 'ن ع م'],
  'hopeful':        ['ر ج و', 'ر ح م'],
  'hope':           ['ر ج و', 'ر ح م'],
  'strength':       ['ص ب ر', 'ق و و'],
  'weak':           ['ض ع ف', 'ص ب ر'],
  'weakness':       ['ض ع ف'],
  'peaceful':       ['س ل م', 'ت و ك ل', 'ذ ك ر'],
  'contentment':    ['ق ن ع', 'ر ض ي'],
  'content':        ['ق ن ع', 'ر ض ي'],
  'joy':            ['ف ر ح', 'ن ع م'],
  'happy':          ['ف ر ح', 'ن ع م', 'ش ك ر'],
  'happiness':      ['ف ر ح', 'ن ع م'],
  'struggling':     ['ص ب ر', 'ب ل و', 'ج ه د'],
  'hardship':       ['ص ب ر', 'ع س ر', 'ب ل و'],
  'difficulty':     ['ع س ر', 'ص ب ر', 'ب ل و'],
  'ease':           ['ي س ر', 'ف ر ج'],
  'relief':         ['ف ر ج', 'ي س ر', 'ن ص ر'],
  'feeling':        ['ق ل ب', 'ن ف س'],
  'struggling with':['ص ب ر', 'ب ل و'],
  'tests':          ['ب ل و', 'ف ت ن', 'ص ب ر'],
  'test':           ['ب ل و', 'ف ت ن'],
  'trial':          ['ب ل و', 'ف ت ن', 'ص ب ر'],
  'trials':         ['ب ل و', 'ف ت ن'],
  ...
  // ── Book-derived concept expansions (Afzal-ur-Rahman Subject Index) ─────
  'accountability':                  ['ح س ب'],
  'adultery':                        ['ز ن ي', 'ف ح ش'],
  'afterlife':                       ['ا خ ر', 'ب ع ث'],
  'alcohol':                         ['خ م ر', 'س ك ر'],
  'almsgiving':                      ['ز ك و', 'ص د ق'],
  'anatomy':                         ['خ ل ق', 'ن ف س'],
  'anger':                           ['غ ض ب'],
  'animals':                         ['ح ي و', 'خ ل ق'],
  'ansar':                           ['ن ص ر', 'ا ن ص'],
  'apostasy':                        ['ر د د', 'ك ف ر'],
  'astronomy':                       ['س م و', 'ف ل ك', 'ن ج م'],
  'atheism':                         ['ك ف ر', 'ا ل ح'],
  'backbiting':                      ['غ ي ب', 'غ م ز'],
  'bani israel':                     ['ب ن و', 'ي ع ق'],
  'biology':                         ['خ ل ق', 'ح ي ي', 'ن ب ت'],
  'birds':                           ['ط ي ر'],
  'blessings of allah':              ['ن ع م', 'ف ض ل'],
  'book of allah':                   ['ك ت ب', 'ق ر ا'],
  'botany':                          ['ن ب ت', 'ز ر ع', 'ش ج ر'],
  'brotherhood':                     ['ا خ و', 'ا م م'],
  'business':                        ['ت ج ر', 'ب ي ع', 'ع م ل'],
  'caliphate':                       ['خ ل ف'],
  'children of israel':              ['ب ن و', 'ي ع ق'],
  'christians':                      ['ن ص ر', 'ا ه ل'],
  'commerce':                        ['ت ج ر', 'ب ي ع'],
  'community':                       ['ا م م'],
  'companions':                      ['ص ح ب'],
  'congregational prayer':           ['ج م ع', 'ص ل و'],
  'consultation':                    ['ش و ر'],
  'day of judgment':                 ['ي و م', 'ح س ب', 'ق ض ي'],
  'debt':                            ['د ي ن', 'ق ر ض'],
  'deception':                       ['ك ذ ب', 'خ د ع'],
  'devil':                           ['ش ي ط', 'ا ب ل'],
  'dhikr':                           ['ذ ك ر'],
  'diet':                            ['ح ل ل', 'ط ي ب', 'ر ز ق'],
  'divine book':                     ['ك ت ب', 'ن ز ل'],
  'economy':                         ['م ا ل', 'ر ز ق', 'ن ف ق'],
  'emigrants':                       ['ه ج ر'],
  'equality':                        ['م س و', 'ع د ل'],
  'equity':                          ['ق س ط', 'ع د ل'],
  'etiquette':                       ['ا د ب', 'خ ل ق'],
  'fear of allah':                   ['خ ش ي', 'خ و ف'],
  'food':                            ['ط ع م', 'ر ز ق', 'ح ل ل'],
  'forbidden food':                  ['ح ر م', 'خ ب ث'],
  'fornication':                     ['ز ن ي', 'ف ح ش'],
  'friday prayer':                   ['ج م ع', 'ص ل و'],
  'fruits':                          ['ث م ر', 'ف ك ه'],
  'gardens of paradise':             ['ج ن ن', 'ف ر د'],
  'good character':                  ['خ ل ق', 'ح س ن'],
  'governance':                      ['خ ل ف', 'ح ك م'],
  'gratitude for blessings':         ['ش ك ر', 'ن ع م'],
  'grave':                           ['ق ب ر', 'م و ت'],
  'greed':                           ['ش ح ح', 'ط م ع'],
  'helpers':                         ['ن ص ر', 'ا ن ص'],
  'hope':                            ['ر ج و', 'ا م ل'],
  'hospitality':                     ['ض ي ف', 'ك ر م'],
  'iblis':                           ['ا ب ل', 'ش ي ط'],
  'idolatry':                        ['ش ر ك', 'و ث ن'],
  'idols':                           ['و ث ن', 'ص ن م'],
  'ingratitude':                     ['ك ف ر', 'ج ح د'],
  'intellect':                       ['ع ق ل', 'ح ك م'],
  'intoxicants':                     ['خ م ر', 'س ك ر', 'ن ب ذ'],
  'invitation to islam':             ['د ع و', 'ب ل غ'],
  'jealousy':                        ['ح س د', 'غ ي ر'],
  'jews':                            ['ي ه و', 'ه و د'],
  'jihad':                           ['ج ه د', 'ق ت ل'],
  'jinn':                            ['ج ن ن'],
  'kaaba':                           ['ب ي ت', 'ح ر م'],
  'lawful food':                     ['ح ل ل', 'ط ي ب'],
  'leadership':                      ['ا م م', 'ح ك م'],
  'life':                            ['ح ي ي', 'ع م ر'],
  'loan':                            ['ق ر ض', 'د ي ن'],
  'lying':                           ['ك ذ ب'],
  'manners':                         ['خ ل ق', 'ا د ب'],
  'martyrdom':                       ['ش ه د', 'ق ت ل'],
  'martyrs':                         ['ش ه د'],
  'mecca':                           ['م ك ك', 'ح ر م'],
  'medina':                          ['م د ن', 'ه ج ر'],
  'mind':                            ['ع ق ل', 'ف ك ر'],
  'miracles':                        ['ا ي ا', 'م ع ج'],
  'moon':                            ['ق م ر'],
  'morning prayer':                  ['ف ج ر', 'ص ل و'],
  'mosque':                          ['م س ج'],
  'mountains':                       ['ج ب ل'],
  'muhajireen':                      ['ه ج ر'],
  'muhajiroon':                      ['ه ج ر'],
  'nation':                          ['ا م م'],
  'night prayer':                    ['ل ي ل', 'ت ه ج'],
  'people of the book':              ['ا ه ل', 'ك ت ب'],
  'planets':                         ['ف ل ك', 'ن ج م'],
  'plants':                          ['ن ب ت', 'ز ر ع', 'ش ج ر'],
  'poverty':                         ['ف ق ر', 'م س ك'],
  'preaching':                       ['ب ل غ', 'د ع و'],
  'promise':                         ['ع ه د', 'و ع د'],
  'prophethood':                     ['ن ب و', 'ر س ل'],
  'punishment of grave':             ['ع ذ ب', 'ق ب ر'],
  'rain':                            ['م ط ر', 'غ ي ث'],
  'reason':                          ['ع ق ل'],
  'reckoning':                       ['ح س ب', 'ح ك م'],
  'record of deeds':                 ['ك ت ب', 'ح ص ي'],
  'rights':                          ['ح ق ق', 'ع د ل'],
  'rivers':                          ['ن ه ر', 'م ا ي'],
  'satan':                           ['ش ي ط', 'ع د و'],
  'scales':                          ['و ز ن', 'م ي ز'],
  'sea':                             ['ب ح ر'],
  'signs of allah':                  ['ا ي ا', 'خ ل ق'],
  'sky':                             ['س م و'],
  'slander':                         ['ب ه ت', 'ا ف ك'],
  'spending':                        ['ن ف ق', 'ص د ق'],
  'spirit':                          ['ر و ح'],
  'stars':                           ['ن ج م', 'ك و ك ب'],
  'stinginess':                      ['ب خ ل', 'ش ح ح'],
  'straight path':                   ['ص ر ط', 'ه د ي'],
  'sun':                             ['ش م س'],
  'sustenance':                      ['ر ز ق'],
  'tawakkul':                        ['و ك ل'],
  'test':                            ['ب ل و', 'ف ت ن'],
  ...
  // ── Subjects from Afzal-ur-Rahman Subject Index (verified English labels) ──
  'ablution':                            ['ط ه ر', 'و ض ا'],
  'adjuration':                          ['ي م ن'],
  'adornment':                           ['ز ي ن'],
  'architecture':                        ['ج ب ل', 'ر ا ي'],
  'badr, battle of':                     ['ك ف ر', 'ق ت ل'],
  'bible':                               ['ك ت ب', 'ح ق ق', 'ص د ق', 'ل م ا'],
  'canals':                              ['خ ي ر'],
  'castles':                             ['ك ا ي', 'ق ر ي', 'ه ل ك', 'ظ ل م'],
  'chemistry':                           ['ح م م', 'ن و ر'],
  'child birth':                         ['و ل د', 'ف ص ل'],
  'christianity':                        ['ع ي س', 'ا ه ل'],
  'cleanliness':                         ['ط ه ر'],
  'dress':                               ['ل ب س', 'ز ي ن'],
  'education':                           ['ع ل م', 'ح ك م'],
  'emigration':                          ['ه ج ر'],
  'farming':                             ['ز ر ع', 'ح ر ث'],
  'fish':                                ['ب ح ر', 'ح و ت'],
  'gambling':                            ['خ م ر', 'ي س ر'],
  'geography':                           ['ا ر ض', 'س ي ر'],
  'geology':                             ['ا ر ض', 'ص خ ر'],
  'good deeds':                          ['ع م ل', 'ص ل ح', 'ا ج ر'],
  'hajj':                                ['ح ج ج', 'ط و ف'],
  'heritage':                            ['و ر ث', 'م و ت'],
  'horses':                              ['خ ي ل', 'ر ك ب'],
  'interest and greed':                  ['ر ب و', 'ا ك ل'],
  'islamic law':                         ['ح ك م', 'ش ر ع'],
  'islamic personality':                 ['ب ل ي', 'س ل م', 'و ج ه'],
  'labour':                              ['ع م ل', 'ك س ب'],
  'logic':                               ['ا د م'],
  'metals':                              ['ح د د', 'ن ح س'],
  'miserliness':                         ['ب خ ل'],
  'morality':                            ['خ ل ق', 'ح س ن'],
  'oaths':                               ['ي م ن', 'ع ه د'],
  'orphan':                              ['ي ت م'],
  'physics':                             ['خ ل ق', 'ح ي ي'],
  'prosperity':                          ['ف ل ح', 'ف و ز'],
  'quraish':                             ['ق ر ش'],
  'rainfall':                            ['م ط ر', 'غ ي ث'],
  'redemption':                          ['ف د ي', 'ص و م'],
  'salat':                               ['ص ل و', 'ق و م'],
  'shahadah':                            ['ك ت ب', 'ب غ ي'],
  'ships':                               ['ف ل ك', 'ب ح ر'],
  'shirk':                               ['ش ر ك'],
  'social responsibility':               ['ك ل ل', 'و ل ي'],
  'sociology':                           ['ه د ي', 'ا ل ي'],
  'space':                               ['س م و', 'ف ل ك'],
  'stealing':                            ['س ر ق'],
  'trust in god':                        ['و ك ل'],
  'universe':                            ['س م و', 'خ ل ق'],
  'veil':                                ['ح ج ب', 'و ق ي'],
  'woman':                               ['ن س و', 'م ر ا', 'ز و ج'],
  'wudu':                                ['ط ه ر', 'و ض ا'],
  'zina':                                ['ز ن ي', 'ف ح ش'],


  // ── Parekh Dictionary — additional English synonyms ───────────────────────
  'adversity':                     ['ض ر ر', 'ب ا س'],
  'affliction':                    ['ب ل و', 'م س س'],
  'anguish':                       ['ض ي ق', 'ح ز ن'],
  'anxiety':                       ['ه م م', 'خ و ف'],
  'atonement':                     ['ك ف ر', 'ت و ب'],
  'blindness':                     ['ع م ي', 'ض ل ل'],
  'boasting':                      ['ف خ ر', 'خ ي ل'],
  'confusion':                     ['ح ي ر', 'ض ل ل'],
  'contentment':                   ['ر ض و', 'ق ن ع'],
  'contumacy':                     ['ك ب ر', 'ع ت و'],
  'custodian':                     ['ا م ن', 'ح ف ظ'],
  'deliverance':                   ['ن ج و', 'خ ل ص'],
  'despair':                       ['ي ا س', 'ق ن ط'],
  'doubt':                         ['ش ك ك', 'ر ي ب'],
  'enmity':                        ['ع د و'],
  'expiation':                     ['ك ف ر', 'ف د ي'],
  'extravagance':                  ['س ر ف', 'ب ذ ر'],
  'grief':                         ['ح ز ن'],
  'grudge':                        ['ح ق د', 'غ ل ل'],
  'guardian':                      ['و ل ي', 'ح ف ظ'],
  'hardship':                      ['ع س ر', 'ض ر ر'],
  'heedless':                      ['غ ف ل'],
  'heedlessness':                  ['غ ف ل'],
  'mindfulness':                   ['ذ ك ر', 'خ ش ي'],
  'misguidance':                   ['ض ل ل', 'غ و ي'],
  'mockery':                       ['س خ ر'],
  'oath':                          ['ي م ن', 'ح ل ف'],
  'perdition':                     ['خ س ر', 'ه ل ك'],
  'perseverance':                  ['ص ب ر'],
  'pledge':                        ['ع ه د', 'و ع د'],
  'reassurance':                   ['ط م ن', 'ا م ن'],
  'refuge':                        ['ع و ذ'],
  'retaliation':                   ['ق ص ص', 'ع ق ب'],
  'retribution':                   ['ق ص ص', 'ع ذ ب'],
  'ridicule':                      ['س خ ر'],
  'ruin':                          ['ه ل ك', 'د م ر'],
  'salvation':                     ['ن ج و', 'ف و ز'],
  'serenity':                      ['س ك ن', 'ط م ن'],
  'sorrow':                        ['ح ز ن', 'ا س ف'],
  'steadfastness':                 ['ص ب ر', 'ث ب ت'],
  'stewardship':                   ['خ ل ف', 'ا م ن'],
  'straying':                      ['ض ل ل'],
  'suspicion':                     ['ظ ن ن'],
  'testimony':                     ['ش ه د'],
  'thankfulness':                  ['ش ك ر'],
  'tranquility':                   ['س ك ن', 'ط م ن'],
  'treachery':                     ['خ ي ن', 'غ د ر'],
  'vicegerency':                   ['خ ل ف'],
  'vow':                           ['ن ذ ر'],
  'waste':                         ['س ر ف', 'ب ذ ر'],
  'wickedness':                    ['ف س ق', 'ف ج ر'],
  'witness':                       ['ش ه د'],
  'wrath':                         ['غ ض ب'],
